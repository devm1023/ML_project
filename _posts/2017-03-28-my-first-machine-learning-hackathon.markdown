...
With the challenge I realized what can be done. Probably since it was an hackathon, there was more rigour to improve prediction accuracy. It felt like an achievement to get a 97.6% accuracy on such a problem. If I were to solve it on my own, probably I would have given up at over 95% accuracy. 
